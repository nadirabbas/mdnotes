    ...
    <div class="auth-card">
      ...
      <form @submit.prevent="handleSubmit" class="auth-form">
        <div class="form-group">
          ...
          <input id="name" v-model="name" type="text" class="input" placeholder="Jane Doe" autocomplete="name" required />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="input-pw-wrap">
            <input id="password" v-model="password" :type="showPw ? 'text' : 'password'" class="input" placeholder="Min. 8 characters" autocomplete="new-password" required minlength="8" />
...
async function handleSubmit() {
  ...
  try {
    ...
    await auth.register(name.value, email.value, password.value, recaptchaToken)
